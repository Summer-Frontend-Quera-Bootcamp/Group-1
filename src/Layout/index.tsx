...
return(
    <div >
        <div className="h-[55px] w-[1280px]  mt-[80px] mr-[80px] ml-[80px]  flex items-center justify-between ">
                <div className="w-[235px] h-[55px] text-[32px] font-extrabold capitalize not-italic leading-normal text-right linear-gradient-heading ">کوئرا تسک منیجر</div>
        ...
        <div className=" w-[100vw] h-[60vh] linear-gradient mt-[315px]  skew-y-[-5deg] ">
