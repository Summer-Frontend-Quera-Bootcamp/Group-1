    ...
    <Profile/>
      ...
      <Formik initialValues={initialValues} onSubmit={()=>{}} validateOnMount >
       ...
       <div className="title-info mb-4">
        ...
        <div className='flex flex-col mb-2.5'><Input type='text' label='نام' autoCompleteField='email' /></div>
        <div className='flex flex-col mb-2.5'><Input type='text' label='نام خانوادگی' autoCompleteField='text' /></div>
...
function Button (){
    return <button type='submit' className='flex items-center justify-start gap-2 rounded-md bg-teal-600 text-white px-12 py-2 font-extrabold'>ثبت تغییرات</button>
}
function ButtonInfo(){
  return <button className='flex p-3 items-start gap-3 border rounded-lg border-cyan-300 text-cyan-300'>ویرایش تصویر پروفایل</button>
}
function ProfilePic(){
