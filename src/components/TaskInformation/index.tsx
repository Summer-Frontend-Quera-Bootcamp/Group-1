...
export const TaskInformation = () => {
  return (
    <div className="w-[750px] h-[596px] rounded-[20px]">
      <div className="flex items-center justify-center gap-[24px] px-[20px] pt-[196px]">
      ...
      <div className="flex flex-col gap-[24px] items-start justify-center mt-16 mx-[40px]">
        ...
        <div className="flex flex-col gap-[12px] ">
          ...
          <p className="p-[12px] text-base font-normal leading-normal border rounded-[12px]">
          ...
          <div className="flex gap-[4px] items-center text-brand-primary cursor-pointer">{Icons.addBox("#208D8E")}
        <p className="text-xs">
        اضافه کردن چک لیست
        </p>
        </div>
