...
const NewTask = () => {
	return (
		<div
			dir='ltr'
			className='w-[1153px] h-[637px] p-8 bg-white rounded-[20px] shadow flex-col justify-start items-end gap-10 inline-flex'
		>
			...
			<div className='self-stretch justify-end items-center gap-2 inline-flex'>
				<button className='w-[34px] h-[34px] p-[4.25px] rounded-[106.25px] border border-stone-300 justify-center items-center gap-[10.62px] flex'>
				...
				<div className='h-8 px-2 pt-[5px] pb-1 bg-white rounded-md border border-gray-200 justify-end items-center gap-2.5 flex'>
					<div className="text-right text-stone-900 text-base font-medium font-['IranYekan Regular']">
						پروژه اول
					</div>
				</div>
			...
			<div className='self-stretch justify-between items-center inline-flex'>
				<button className='w-[125px] h-8 px-[7px] py-1 bg-brand-primary rounded justify-center items-center gap-2.5 flex'>
				...
				<div className='justify-end items-center gap-6 flex'>
					<button className='w-[50px] h-[50px] p-[6.67px] rounded-[138.89px] border border-stone-300 justify-center items-center flex'>
