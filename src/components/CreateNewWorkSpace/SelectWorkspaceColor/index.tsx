...
import disturb from "../../../assets/Icons/disturb.svg";
...
const SelectWorkspaceColor: React.FC<ISelectWorkspaceColor> = ({teamTitle, children, onColorReceived}): JSX.Element => {
